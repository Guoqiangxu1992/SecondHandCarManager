...
public class DateFormat1{
	...
	public static int getMonthSpace(String date1, String date2) {
		...
		result =12*(c2.get(Calendar.YEAR) - c1.get(Calendar.YEAR) )+ c2.get(Calendar.MONDAY) - c1.get(Calendar.MONTH);
	 ...
	 * @return
	 */
	public static int compareDays(String date1,String date2) throws ParseException{
		SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd");
		Date d1 = sf.parse(date1);
		Date d2 = sf.parse(date2);
		Long c =d1.getTime()-d2.getTime();
		int d = (int) (c/1000/60/60/24);//天
		return  d == 0 ? 1 : Math.abs(d);
	}
    
    public static void main(String[] args) throws ParseException {
    	System.out.println(DateUtil.compareDays("2015-10-01","2015-11-11"));
    }
}
