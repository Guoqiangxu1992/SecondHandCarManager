        	...
        	<div class="reg-box" id="verifyCheck" style="margin-top:20px;">
            	<div class="part1">                	
                    <div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" maxlength="20" class="txt03 f-r3 required" tabindex="1" data-valid="isNonEmpty||between:3-20||isUname" data-error="用户名不能为空||用户名长度3-20位||只能输入中文、字母、数字、下划线，且以中文或字母开头" id="loginName" />                            <span class="ie8 icon-close close hide"></span>
                    ...
                    <div class="item col-xs-12" 
							...
							<span class="intelligent-label f-fl"><b class="ftx04">*</b>出生日期：</span>  
							 <div>
							 		<input  style = "width:270px" type="text" size="16"name="birthday" id="birthday"class="form-control form_date">
							 </div>
						</div>
						  <div class="item col-xs-12" 
							data-date="2012-12-21T15:25:00Z">
							<span class="intelligent-label f-fl"><b class="ftx04">*</b>邮箱：</span>  
							 <div>
							 		<input  style = "width:270px" type="text" size="16"name="email" id="email">
							 </div>
						</div>
                    <div class="item col-xs-12">
                ...
                <div class="part3" style="display:none">
                	<div class="item col-xs-12">
                        ...
                        <div class="f-fl item-ifo">
                            <input type="text" maxlength="10" class="txt03 f-r3 required" tabindex="1" data-valid="isNonEmpty||between:2-10||isZh" data-error="真实姓名不能为空||真实姓名长度2-10位||只能输入中文" id="name" />   
                            <span class="ie8 icon-close close hide"></span>                         
                            <label class="icon-sucessfill blank hide"></label>
...
$(function(){	
	...
	$("#btn_part3").click(function(){
		...
		alert(errorMsg);
		var aj = $.ajax( {    
		    url:'${xgq}/user/register.do',// 跳转到 action    
		    data:{    
		             loginName : loginName,    
		             name : name,    
		             birthday : birthday,    
